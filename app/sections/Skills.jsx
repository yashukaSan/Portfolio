...
import {CodeXml, Server, Layers, Database, Plus, MoveRight } from 'lucide-react' 
...
export default function Skills(){
    ...
    return (
        <section className="h-screen overflow-hidden bg-[#505065]/80 flex flex-col justify-center items-center" >
            ...
            <ul className="grid lg:gap-3 xl-grid-cols-5 xl-gap-10 gap-3 grid-cols-2 lg:grid-cols-4" >
            <li className="w-[45vw] transition duration-400 hover:bg-linear-to-r from-[#dd89] px-12 py-5 border rounded-3xl bg-[#182535] " onMouseEnter={()=>{setIsHover(true); setHoverCount(3)} } onMouseLeave={()=>{setIsHover(false); setHoverCount(NaN)}} >
                    ...
                    <h1 className={isHover && hoverCount===3 ? "text-5xl font-serif text-green-300" : "text-4xl font-bold"}>
                        <span className={isHover && hoverCount===3 ? "text-6xl font-serif text-green-400" : "text-5xl font-serif text-lime-400"} >M</span>ongoDB
                    </h1>
                ...
                <li className="w-[45vw] px-12 py-5 border transition duration-400 hover:bg-linear-to-r from-[#dd89] rounded-3xl bg-[#182535] " onMouseEnter={()=>{setIsHover(true); setHoverCount(4)} } onMouseLeave={()=>{setIsHover(false); setHoverCount(NaN)}} >
                    ...
                    <h1 className={isHover && hoverCount===4 ? "text-5xl font-serif text-green-300" : "text-4xl font-bold"}>
                    <span className={isHover && hoverCount===4 ? "text-6xl font-serif text-green-400" : "text-5xl font-serif text-lime-400"} >E</span>xpress
                    </h1>
                ...
                <li className="w-[45vw] transition duration-400 hover:bg-linear-to-r from-[#dd89] px-12 py-5 border rounded-3xl bg-[#182535] " onMouseEnter={()=>{setIsHover(true); setHoverCount(1)} } onMouseLeave={()=>{setIsHover(false); setHoverCount(NaN)}} >
                    ...
                    <h1 className={isHover && hoverCount===1 ? "text-5xl font-serif text-green-300" : "text-4xl font-bold hover:text-black"}>
                    <span className={isHover && hoverCount===1 ? "text-6xl font-serif text-green-400" : "text-5xl font-serif text-lime-400"} >R</span>eact
                    </h1>
                ...
                <li className="w-[45vw] transition duration-400 hover:bg-linear-to-r from-[#dd89]  px-12 py-5 border rounded-3xl bg-[#182535] " onMouseEnter={()=>{setIsHover(true); setHoverCount(2)} } onMouseLeave={()=>{setIsHover(false); setHoverCount(NaN)}} >
                    ...
                    <h1 className={isHover && hoverCount===2 ? "text-5xl font-serif text-green-300" : "text-4xl font-bold"}>
                    <span className={isHover && hoverCount===2 ? "text-6xl font-serif text-green-400" : "text-5xl font-serif text-lime-400"} >N</span>ode.js
                    </h1>
                    <p className={isHover && hoverCount===2 ? "text-xl text-pink-100 mt-3 " : "text-xl text-slate-400 mt-3"} >
                        Intermediate
                    </p>
                </li>
                <li className="w-[45vw] m-auto relative transition duration-400 hover:bg-linear-to-r from-[#dd89]  px-12 py-5 border rounded-3xl bg-[#182535] " onMouseEnter={()=>{setIsHover(true); setHoverCount(2)} } onMouseLeave={()=>{setIsHover(false); setHoverCount(NaN)}} >
                    <div>
                        <div><Plus /> View More</div>
                        <MoveRight />
                    </div>
                </li>
